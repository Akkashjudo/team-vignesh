    ...
    <AnimatePresence>
      {visible && (
        <m.a
          ...
          className="group fixed bottom-4 right-4 z-40 flex h-14 items-center gap-3 rounded-sm border border-[#25D366]/35 bg-ink-elevated/95 px-4 text-bone shadow-[0_8px_30px_rgba(0,0,0,0.55)] transition-colors hover:border-[#25D366] hover:bg-[#25D366] hover:text-ink sm:bottom-6 sm:right-6"
        >
